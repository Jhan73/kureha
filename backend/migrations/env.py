...
# The connection string is owned by app.config.settings (pydantic-settings,
# reads DATABASE_URL / .env.local), not by the `sqlalchemy.url` placeholder
# in alembic.ini — this keeps a single source of truth between the app and
